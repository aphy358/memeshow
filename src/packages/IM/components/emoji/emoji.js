...
Component({
   ...
   */
  data: {
    localAlbumImages: ['/packages/IM/images/album-emoji.png', '/packages/IM/images/album-ajtd.png', '/packages/IM/images/album-xxy.png', '/packages/IM/images/album-lt.png'],
    albumArr: [],
    currentAlbum: 'emoji',
    emojiList: {},
