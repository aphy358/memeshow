Page({
  ...
  setVisibleList(firstIndex){
    firstIndex = firstIndex || this.data.firstIndex
    this.setData({
      dataList: this.data.dataList0.slice(firstIndex, firstIndex + 3),
  ...
  firstView(e) {
    ...
    let firstIndex = this.data.firstIndex - 1
    this.setVisibleList(firstIndex)
  },
  beforeViewChange(e) {
